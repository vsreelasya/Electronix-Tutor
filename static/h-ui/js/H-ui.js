...
jQuery.Huifold = function(obj,obj_c,speed,obj_type,Event){
		...
		$("#TopicOfToday").removeClass("selected");
		if($("#TopicOfToday").find("b")){
		$("#TopicOfToday").find("b").html("+");
		}
		$("#TopicOfToday").next().slideDown(speed).end().addClass("selected");
		if($("#TopicOfToday").find("b")){
		$("#TopicOfToday").find("b").html("-");
		}
	if(obj_type == 2){
	...
	$(obj).on(Event,function(){
		if($(this).next().is(":visible")){
			if(obj_type == 2){
				...
				if(this.id!="RecommendedProblemsMenu" || this.id!="TopicOfToday")
				{
			...
			if(obj_type == 3){
				...
				else if(this.id!="RecommendedProblemsMenu" || this.id!="TopicOfToday")
				{
	...
	$("a.preview").hover(
		function(){
			...
			if(midimg ==''){return false;}
				...
				var imgTitle = this.myTitle ? "<br />" + this.myTitle + " 11111" : "";
